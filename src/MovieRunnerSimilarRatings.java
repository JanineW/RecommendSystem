...
public class MovieRunnerSimilarRatings {
    ...
    public void printSimilarRatings() {
        ...
        if (ratings.size() == 0 || ratings.size() == 1)
            System.out.println(ratings.size() + " movie matched------printSimilarRatings");
        else
            System.out.println(ratings.size() + " movies matched--------printSimilarRatings");
    ...
    public void printSimilarRatingsByGenre() {
        ...
        if (ratings.size() == 0 || ratings.size() == 1)
            System.out.println(ratings.size() + " movie matched-------printSimilarRatingsByGenre");
        else
            System.out.println(ratings.size() + " movies matched----------printSimilarRatingsByGenre");
        for(int i=0; i< ratings.size(); i++) {
            if (i<15)
                System.out.printf("%d %.2f %s\n", i, ratings.get(i).getValue(), MovieDatabase.getTitle(ratings.get(i).getItem()));
        }
    ...
    public void printSimilarRatingsByDirector() {
        ...
        ArrayList<Rating> ratings = fr.getSimilarRatingsByFilter(raterID, numSimilarRaters, minimalRaters, filterCriteria);
        if (ratings.size() == 0 || ratings.size() == 1)
            System.out.println(ratings.size() + " movie matched--------printSimilarRatingsByDirector");
        else
            System.out.println(ratings.size() + " movies matched---------printSimilarRatingsByDirector");
        for(int i=0; i< ratings.size(); i++) {
            if (i<15)
                System.out.printf("%d %.2f %s\n", i, ratings.get(i).getValue(), MovieDatabase.getTitle(ratings.get(i).getItem()));
        }
    ...
    public void printSimilarRatingsByGenreAndMinutes() {
        ...
        ArrayList<Rating> ratings = fr.getSimilarRatingsByFilter(raterID, numSimilarRaters, minimalRaters, filterCriteria);
        if (ratings.size() == 0 || ratings.size() == 1)
            System.out.println(ratings.size() + " movie matched----------printSimilarRatingsByGenreAndMinutes");
        else
            System.out.println(ratings.size() + " movies matched----------printSimilarRatingsByGenreAndMinutes");
        for(int i=0; i< ratings.size(); i++) {
            if (i<15)
                System.out.printf("%d %.2f %s\n", i, ratings.get(i).getValue(), MovieDatabase.getTitle(ratings.get(i).getItem()));
        }
    ...
    public void printSimilarRatingsByYearAfterAndMinutes() {
        ...
        ArrayList<Rating> ratings = fr.getSimilarRatingsByFilter(raterID, numSimilarRaters, minimalRaters, filterCriteria);
        if (ratings.size() == 0 || ratings.size() == 1)
            System.out.println(ratings.size() + " movie matched--------printSimilarRatingsByYearAfterAndMinutes");
        else
            System.out.println(ratings.size() + " movies matched---------printSimilarRatingsByYearAfterAndMinutes");
        for(int i=0; i< ratings.size(); i++) {
            if (i<15)
                System.out.printf("%d %.2f %s\n", i, ratings.get(i).getValue(), MovieDatabase.getTitle(ratings.get(i).getItem()));
        }
